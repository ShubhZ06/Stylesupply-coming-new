  ...
  return (
    <main className="relative min-h-dvh w-full flex flex-col items-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-97.5 md:max-w-120 px-5">
        ...
        <div className="relative w-full sm:mt-[-3.5rem] mt-0" style={{ zIndex: 10 }}>
          {children}
        </div>

        <div
          className="mt-[30px] sm:mt-1 flex flex-col items-center gap-[30px] w-full pb-14"
          style={{ animation: "stagger-up 0.7s ease-out 0.65s both" }}
        >
          <p className="font-semibold text-white text-[24px] tracking-[-0.04em] whitespace-nowrap leading-[38px]">
            14th April
          </p>

          <div className="flex flex-col items-center gap-[20px] w-full" style={{ animation: "stagger-up 0.7s ease-out 0.75s both" }}>
            {stage === "button" && (
              <button
                type="button"
